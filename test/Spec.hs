...
main = runTestsEx [
    ...
    (StatementEqual.test "int main() { int ar[3]; for (int i = 0; i < 3; i = i + 1) ar[i] = i; return ar[0]; }", 0),
    (StatementEqual.test "int main() { int ar[3]; for (int i = 0; i < 3; i = i + 1) ar[i] = i; return ar[1]; }", 1),
    (StatementEqual.test "int main() { int ar[3]; for (int i = 0; i < 3; i = i + 1) ar[i] = i; return ar[2]; }", 2),
