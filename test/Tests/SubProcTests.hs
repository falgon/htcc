...
exec = runTestsEx
    ...
    , (StatementEqual.test "main() { a = 1; return a; }", 1)
    , (StatementEqual.test "main() { a = 42; b = 20; return a + b; }", 62)
    , (StatementEqual.test "main() { a = 42; b = 20; c = 32; return (a - c) * b / 10; }", 20)
    , (StatementEqual.test "main() { a = 42; b = 20; return a - b; }", 22)
    , (StatementEqual.test "main() { a = 3; returnb = 5 * 6 - 8; return a + returnb / 2; }", 14)
    , (StatementEqual.test "main() { a = 3; return_ = 5 * 6 - 8; return a + return_ / 2; }", 14)
    , (StatementEqual.test "main() { a /* comment */ = 3; b = 5 */*comment*/ 6 - 8; return a + b / 2; }", 14)
    ...
    , (StatementEqual.test "main() { a = 0; i = 0; for (i = 1; i <= 10; i = i + 1) a = a + i * 2; return a; }", 110)
    , (StatementEqual.test "main() { i = 0; for (; i <= 10;) i = i + 2; return i; }", 12)
    , (StatementEqual.test "main() { i = 0; for (; i <= 10; i = i + 2);  return i; }", 12)
    , (StatementEqual.test "main() { a = 0; i = 0; for (i = 0; i < 10; i = i + 1) if (a) a = 0; else a = 1; return a; }", 0)
    ...
    , (StatementEqual.test "main() { a = 0; i = 0; for (i = 0; i < 10; i = i + 1) if (i % 2 == 0) a = a + i; return a; }", 20)
    , (StatementEqual.test "main() { a = 0; i = 0; for (i = 0; i < 10; i = i + 1) { a = a + i; a = a - i; } return a; }", 0)
