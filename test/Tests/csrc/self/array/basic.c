...
int main()
{
    ...
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *p = 42; **ar; }), "({ int ar[2][3]; int* p = (int*)ar; *p = 42; **ar; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 1) = 42; *(*ar + 1); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 1) = 42; *(*ar + 1); })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 2) = 42; *(*ar + 2); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 2) = 42; *(*ar + 2); })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 3) = 42; **(ar + 1); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 3) = 42; **(ar + 1); })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 4) = 42; *(*(ar + 1) + 1); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 4) = 42; *(*(ar + 1) + 1); })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 5) = 42; *(*(ar + 1) + 2); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 5) = 42; *(*(ar + 1) + 2); })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; *(p + 6) = 42; **(ar + 2); }), "({ int ar[2][3]; int* p = (int*)ar; *(p + 6) = 42; **(ar + 2); })");
    ...
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[0] = 42; ar[0][0]; }), "({ int ar[2][3]; int* p = (int*)ar; p[0] = 42; ar[0][0]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[1] = 42; ar[0][1]; }), "({ int ar[2][3]; int* p = (int*)ar; p[1] = 42; ar[0][1]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[2] = 42; ar[0][2]; }), "({ int ar[2][3]; int* p = (int*)ar; p[2] = 42; ar[0][2]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[3] = 42; ar[1][0]; }), "({ int ar[2][3]; int* p = (int*)ar; p[3] = 42; ar[1][0]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[4] = 42; ar[1][1]; }), "({ int ar[2][3]; int* p = (int*)ar; p[4] = 42; ar[1][1]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[5] = 42; ar[1][2]; }), "({ int ar[2][3]; int* p = (int*)ar; p[5] = 42; ar[1][2]; })");
    assert(42, ({ int ar[2][3]; int* p = (int*)ar; p[6] = 42; ar[2][0]; }), "({ int ar[2][3]; int* p = (int*)ar; p[6] = 42; ar[2][0]; })");
    ...
    assert(4, ({ char x[3]; char (*y)[3] = &x; y[0][0] = 4; y[0][0]; }), "({ char x[3]; char (*y)[3] = &x; y[0][0] = 4; y[0][0]; })");
