...
lookupKeyword s = find ((==) s . tshow) [TKReturn, TKWhile, TKIf, TKElse, TKFor, TKStruct, TKSizeof, TKAlignof, TKTypedef, TKType CR.CTInt, TKType CR.CTChar, TKType CR.CTShort, TKType CR.CTLong]
