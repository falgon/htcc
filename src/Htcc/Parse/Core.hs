...
-- \end{eqnarray}
-- \]
inners :: ([HT.TokenIdx i] -> ATree i -> Vars i -> Either (T.Text, HT.TokenIdx i) ([HT.TokenIdx i], ATree i, Vars i)) -> [(String, ATKind i)] -> [HT.TokenIdx i] -> ATree i -> Vars i -> Either (T.Text, HT.TokenIdx i) ([HT.TokenIdx i], ATree i, Vars i)
